...
- [ ] `app/rag/generator.py` LLM 意图分类（替换关键词方案）
- [ ] `app/rag/vector_store.py` 法条时效性元数据支持
- [ ] `scripts/ingest.py` 入库时标注时效性信息
- [ ] `app/api/routes.py` Prometheus 监控接口
- [ ] `app/core/config.py` 添加监控相关配置
- [ ] 性能测试与优化
- [ ] 文档更新（进度.md、开发指南.md）
